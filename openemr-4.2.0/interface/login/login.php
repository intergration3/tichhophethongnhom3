...
<script>
      ...
      $.ajax({
            ...
            data: dataString,
            cache: false,
            beforeSend: function(){ $("#loginbox").val('Connecting...');},
            success: function(data){
            if(data)
            {
            $("body").load("interface/main/main_screen.php").hide().fadeIn(1500).delay(6000);
            }
            }
            });
      return false;
...
<td>
<input class="entryfield" type="text" size="10" name="authUser" id="usernameid">
</td></tr><tr>
<td><span class="text"><?php echo xlt('Password:'); ?></span></td>
<td>
<input class="entryfield" type="password" size="10" name="clearPass" id="passwordid">
</td></tr>
...
<tr><td>&nbsp;</td><td>
  <input class="button large" type="submit" id="linkToClick2" onClick="autogetUsername()" value="<?php echo xla('Fill');?>">
<input class="button large" type="submit" id="linkToClick" onClick="transmit_form()" value="<?php echo xla('Login');?>">
</td></tr>
<tr><td colspan='2' class='text' style='color:red'>
<?php
